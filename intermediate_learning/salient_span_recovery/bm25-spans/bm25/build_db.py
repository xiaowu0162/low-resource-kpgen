...
def get_contents(filename):
    ...
    for extracted_item in extracted_items:
        ...
        abstract = extracted_item["abstract"]
        text = extracted_item["plain_text"]
        documents.append((id, title, abstract, text))
    return documents


def store_contents(filenames, save_path, preprocess, num_workers=None):
    ...
    c = conn.cursor()
    c.execute("CREATE TABLE documents (id PRIMARY KEY, title, abstract, text);")
