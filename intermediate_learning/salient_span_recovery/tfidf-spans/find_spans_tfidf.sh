...
for split in valid test; do
    ...
    python run_tfidf.py --input tfidf/data_${split} --model tfidf --language en --output tfidf/raw_preds/results_tfidf_kp20k_${split}.csv -n 3 -k $NUM_SPANS --stopwords --tags description --redundancy_removal True
done
